...
1.1. Так как валотильность криптовалют сравнительно низкая, то для отображения динамики изменения цен была применена логарифмическая шкала:
![Детальный анализ волатильности](image-3.png)
1.2. Аналитика представлена также в таблице CSV:
![Таблица](image-5.png), темп изменения цены в единицах - USD/мин
