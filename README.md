...
«Запуск и использование» следующие пункты:

Запуск сервера: Укажи точную команду, которую ты использовал:
uvicorn api.main_api_1:app --reload --port 8008

Документация (Swagger): Напиши крупно:

Интерактивная документация доступна по адресу: http://127.0.0.1:8008/docs

Примеры запросов: Прямо в тексте дай ссылку на твой любимый эндпоинт, например:
http://127.0.0.1:8008/prices?limit=10
